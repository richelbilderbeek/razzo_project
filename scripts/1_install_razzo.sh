...
Rscript -e 'devtools::install_github("ropensci/beautier", ref = "v2.3.3", dependencies = TRUE)'
Rscript -e 'devtools::install_github("ropensci/tracerer", ref = "v2.0.3", dependencies = TRUE)'
Rscript -e 'devtools::install_github("ropensci/beastier", ref = "v2.1.2", dependencies = TRUE)'
Rscript -e 'devtools::install_github("ropensci/mauricer", ref = "v2.0.6", dependencies = TRUE)'
Rscript -e 'devtools::install_github("ropensci/babette", ref = "v2.1.1", dependencies = TRUE)'
